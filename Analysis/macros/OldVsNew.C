...

{
  ...
  TFile craft08("BasicHistos08.root","read");
  TFile craft09("BasicHistos.root","read");


  TPostScript* ps = new TPostScript("CRAFT08_vs_09.ps");
  ...
  TFile effCraft08("EffHistos08.root","read");
  TFile effCraft09("EffHistos.root","read");

  TH1D* hEffJetE = (TH1D*)effCraft09.Get("hEffJetE");
  hEffJetE->Draw("HIST");
  TH1D* hEffJetE08 = (TH1D*)effCraft08.Get("hEffJetE");
  hEffJetE08->SetLineColor(2);
  hEffJetE08->Draw("SAME HIST");
  canvas->Update();

  TH1D* hEffJetEta08 = (TH1D*)effCraft08.Get("hEffJetEta");
  hEffJetEta08->SetLineColor(2);
  hEffJetEta08->Draw("HIST");
  TH1D* hEffJetEta = (TH1D*)effCraft09.Get("hEffJetEta");
  hEffJetEta->Draw("SAME HIST");
  canvas->Update();

  TH1D* hEffJetN6008 = (TH1D*)effCraft08.Get("hEffJetN60");
  hEffJetN6008->SetLineColor(2);
  hEffJetN6008->Draw("HIST");
  TH1D* hEffJetN60 = (TH1D*)effCraft09.Get("hEffJetN60");
  hEffJetN60->Draw("HIST SAME");
  canvas->Update();

  TH1D* hEffJetN9008 = (TH1D*)effCraft08.Get("hEffJetN90");
  hEffJetN9008->SetLineColor(2);
  hEffJetN9008->Draw("HIST");
  TH1D* hEffJetN90 = (TH1D*)effCraft09.Get("hEffJetN90");
  hEffJetN90->Draw("HIST SAME");
  canvas->Update();

  TH1D* hEffJetMuVeto08 = (TH1D*)effCraft08.Get("hEffMuVeto");
  hEffJetMuVeto08->SetLineColor(2);
  hEffJetMuVeto08->Draw("HIST");
  TH1D* hEffMuVeto = (TH1D*)effCraft09.Get("hEffMuVeto");
  hEffMuVeto->Draw("HIST SAME");
  canvas->Update();
