...
def makeHistos(tree, filename, cutObj, runtree) :
    ...
    for run in runs:
        ...
        rundir=rdir.mkdir(runstr)
        rdir.cd(runstr)
        basicHistos(tree, rundir, "NoCuts",  "run=="+runstr, 1./livetime)
        basicHistos(tree, rundir, "JetMuCuts", cutObj.jetMu and TCut("run=="+runstr), 1./livetime)
        basicHistos(tree, rundir, "AllCuts", cutObj.allCuts() and TCut("run=="+runstr), 1./livetime)
