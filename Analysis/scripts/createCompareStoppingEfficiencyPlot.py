...
output = TFile('summer11Reproduction_stoppingEff.root', 'RECREATE')
...
gluinoyDen = array('d',
                [50000., 50000., 49900., 50000., 50000., 50000., 49800., 50000., 50000., 49900.])
...
stopyDen = array('d',
                 [49000., 49000., 50000.,50000.,50000.,50000.,])
...
geff_gluino.SetTitle(';m [GeV];#varepsilon_{stop}')
...
geff_stop.SetTitle(';m [GeV];#varepsilon_{stop}')
...
geff_gluino2012.SetTitle(';m [GeV];#varepsilon_{stop}')
...
leg.SetTextFont(42)
leg.AddEntry(geff_gluino2012, '2012 gluinos, #tilde{g} #tilde{g}, #sqrt{s} = 8 TeV', 'l')
leg.AddEntry(geff_gluino, '2011 gluinos, #tilde{g} #tilde{g}, #sqrt{s} = 7 TeV', 'l')
leg.AddEntry(geff_stop2012, '2012 stops, #tilde{t} #tilde{t}, #sqrt{s} = 8 TeV', 'l')
leg.AddEntry(geff_stop, '2011 stops, #tilde{t} #tilde{t}, #sqrt{s} = 7 TeV', 'l')
