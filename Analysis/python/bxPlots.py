...
def bxPlot(fills, ifile, ofile):
    ...
    for fill in fills:
        ...
        hnorm = ifile.Get(fillstr+"/hnormrelbx"+fillstr)
        hbx   = ifile.Get(fillstr+"/hrelbx"+type+fillstr)
    ...
    multiPlot(hbxvec, legvec, ofile, 1E-6, 1E0, "Rel BX (normalised)", "BX", "Hz", "", 4, -20., 20.)

if fillset=="2010A":
    fills=[1117,1118,1119,1121,1122,1134,1179,1182]
    bxPlot(fills, ifile2, ofile)
