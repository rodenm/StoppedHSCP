...
print "New fin counts hist : ", hNewFinRate.Integral() / hNewFinRate.GetEntries()
...
for h in range(0,nHist):
    ...
    print "Rebinning hfilltest_"+str(h)+". Integral = ", hOld.Integral()
...
# output file
ofile = dataset+"/"+dataset+"_NMinusOne_Test.ps"
opdf = dataset+"/"+dataset+"_NMinusOne_Test.pdf"
...
# output file
ofile = TFile(dataset+"/nMinusOne.root", "recreate")
