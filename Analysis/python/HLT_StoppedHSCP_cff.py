# 
# Define a sequence equivalent to HLTStoppedHSCP HLT path
# for use in offline replication of HLT selection
#
# Taken from /cdaq/cosmic/commissioning2009/CRAFT/HLT_3_2_1_onlpatch1/V1
# 9th Sep 09  Jim Brooke
# 
