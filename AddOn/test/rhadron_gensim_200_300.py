...
gluinoMass = 200.
particlesGluinoFile = 'particles_gluino_200_GeV.txt'
stopPointsFile = 'stopped_rhadrons_gluino200_300_14.txt'
nEvents = 100
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('%s.root' % stopPointsFile),
...
process.g4SimHits.Watchers = cms.VPSet (
  cms.PSet(
    ...
    RHStopTracer = cms.PSet(
      ...
      traceEnergy = cms.untracked.double (14000.)
    )        
  )
)
