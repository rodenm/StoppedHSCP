...
gluinoMass = 500.
particlesGluinoFile = 'particles_gluino_500_GeV.txt'
stopPointsFile = 'stopped_rhadrons_gluino500_14TeV_300.txt'
nEvents = 1000
...
#        'MSTP(51)=7      ! CTEQ5L structure function',
        ...
        'IMSS(3)=1',
        'RMSS(3)=500. !should be gluino mass',
        'RMSS(1)=250. !should be gluino mass/2',
        'RMSS(2)=250. !should be gluino mass/2',
        'RMSS(4)=10000.',
        'MDCY(309,1)=0                   ! set gluino stable',
        'IMSS(5)=1',
        'RMSS(10)=1100. !RMSS(10)=2.2*mass gluino',
        'RMSS(11)=1050. !RMSS(10)=2.1*mass gluino',
        'RMSS(8)=100000 !alway 1E5 for rmss(8,9)',
        'RMSS(9)=100000 !RMSS(8-9) make squark/lepton heavy enough to not decay',
        'RMSS(12)=1000.!should be gluino mass X2',
        'MSTJ(14)=-1',
        'MSTP(111)=0'
    ),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('%s_1.root' % stopPointsFile),
...
process.g4SimHits.Physics.particlesDef = cms.FileInPath('particles_gluino_300_GeV.txt')
