// -*- C++ -*-
//
// Package:    RHadronFilter
// Class:      RHadronFilter
// 
/**\class RHadronFilter RHadronFilter.cc SUSYBSMAnalysis/RHadronFilter/src/RHadronFilter.cc
...
class RHadronFilter : public edm::EDFilter {
   public:
      explicit RHadronFilter(const edm::ParameterSet&);
      ~RHadronFilter();
...
//
RHadronFilter::RHadronFilter(const edm::ParameterSet& iConfig)
...
bool
RHadronFilter::jetGood(L1JetParticleCollection::const_iterator &cit) {
  return cit->energy() >= jet_threshold;
}

// ------------ method called on each new Event  ------------
bool
RHadronFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
RHadronFilter::beginJob(const edm::EventSetup&)
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
RHadronFilter::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(RHadronFilter);
