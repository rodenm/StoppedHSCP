...

{
  ...
  TH1F * h = c->DrawFrame(0., 1e-21., 30., 1e-3);
...
//   TGraph * graph1 = toy->getLifetimeCurve(300., 1.e-6, 0);
//   graph1->SetLineColor(1);
//   graph1->SetLineStyle(1);
//   graph1->SetLineWidth(2);
//   graph1->Draw("C");
...
//   TGraph * graph2 = toy->getLifetimeCurve(300., 1.e-3, 0);
//   graph2->SetLineColor(2);
//   graph2->SetLineStyle(1);
//   graph2->SetLineWidth(2);
//   graph2->Draw("C");
...
//   TGraph * graph3 = toy->getLifetimeCurve(300., 3600., 0);
//   graph3->SetLineColor(4);
//   graph3->SetLineStyle(1);
//   graph3->SetLineWidth(2);
//   graph3->Draw("C");
...
//   TGraph * graph4 = toy->getLifetimeCurve(300., 43200., 0);
//   graph4->SetLineColor(1);
//   graph4->SetLineStyle(2);
//   graph4->SetLineWidth(2);
//   graph4->Draw("C");
...
//   TGraph * graph5 = toy->getLifetimeCurve(300., 86400, 0);
//   graph5->SetLineColor(2);
//   graph5->SetLineStyle(2);
//   graph5->SetLineWidth(2);
//   graph5->Draw("C");
...
//   TGraph * graph6 = toy->getLifetimeCurve(300., 604800, 0);
//   graph6->SetLineColor(4);
//   graph6->SetLineStyle(2);
//   graph6->SetLineWidth(2);
//   graph6->Draw("C");
